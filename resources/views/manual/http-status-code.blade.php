			...
			<tbody>
				<tr>
					...
					<td>
						...
						<p><u>HTTP/1.0协议规范中没有定义任何1xx状态码</u>，所以除非在某些试验条件下，服务器禁止向此类客户端发送1xx响应。 这些状态码代表的响应都是信息性的，标示客户应该采取的其他行动。</p></td>
				</tr>
				<tr>
					<th scope="row">2xx</th>
					<td>
				...
				<tr>
					...
					<td>
						...
						<p>当且仅当后续的请求所使用的方法是GET或者HEAD时，用户浏览器才可以在没有用户介入的情况下自动提交所需要的后续请求。按照HTTP/1.0协议规范的建议，浏览器不应自动访问超过5次的重定向。</p>
					</td>
				</tr>
				<tr>
					<th scope="row">4xx</th>
